...
treenode<int>* maxchildsum(treenode<int>* root,treenode<int>** maxnode,int* maxsum){
    if(root == NULL){
        return NULL;
    }
    ...
    for (int i = 0; i < root->children.size(); i++){
        ...
        maxchildsum(root->children[i],maxnode,maxsum);
    }
...
int main(){
    ...
    int maxsum = 0;
    treenode<int>* max = maxchildsum(root,&root,&maxsum);
    cout<<max->data<<endl;
